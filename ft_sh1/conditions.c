...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/01/24 12:38:14 by emammadz          #+#    #+#             */
/*   Updated: 2015/03/13 13:35:46 by emammadz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		check_cd(t_env *e)
{
	if (e->i == 3)
		return (0);
	if ((ft_strequ("cd", e->args[0]) == 1 && e->args[1])
			|| ft_strequ("cd", e->args[0]) == 1)
		return (1);
	return (0);
}
...
void	exec_setenv(t_env *e)
{
	...
	{
		if (env_name_search(get_new_name(e->args[1], 0), e) == 0
